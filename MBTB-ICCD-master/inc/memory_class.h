...
#define TRANSLATION_FROM_L1D                                                   \
  6 // Translation requests coming to STLB when the translation of data prefetch
    // request is missing in DTLB
#define TYPES_SHIFT 7
#define NUM_TYPES TYPES_SHIFT * 2 // Separate account for instruction and data
