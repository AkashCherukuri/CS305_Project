...
//#define SKEWED_SHOTGUN_BTB
#define BASELINE_SHOTGUN_BTB
#define SHOTGUN_PREDECODING
#endif

//#define PUSH_DTLB_PB 	//@Vasudha: Use DTLB Prefetch buffer to store
//translations that are prefetched by DTLB
...
//#define DP(x) {int
//temp=warmup_complete[0];warmup_complete[0]=1;x;warmup_complete[0]=temp;}
