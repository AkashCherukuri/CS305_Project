...
public:
  ...
  uint64_t fetch_start_cycle = 0, fetch_end_cycle = 0, decode_start_cycle = 0,
           decode_end_cycle = 0, execute_start_cycle = 0,
           execute_end_cycle = 0; // Vishal: Latency Breakdown
